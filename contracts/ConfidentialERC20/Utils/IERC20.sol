...
interface IConfidentialERC20 {
     ...
     */
    function transfer(address to, euint64 value) external returns (bool);
     ...
     */
    function approve(address spender, euint64 value) external returns (bool);
     ...
     * Emits a {Transfer} event.
     */
    function transferFrom(address from, address to, euint64 value) external returns (bool);
}